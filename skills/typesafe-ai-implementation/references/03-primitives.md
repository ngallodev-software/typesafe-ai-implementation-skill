...
Use when exactly one member of a known finite candidate set should be selected.
...
- thresholding is application policy, not part of the primitive.

## Score

Use for degree along one ordered dimension.
